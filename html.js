...
//
const START = 'https://developer.mozilla.org/ru/docs/Web/HTML/Element';
const START_EN = 'https://developer.mozilla.org/en-US/docs/Web/HTML/Element';

const ROOT = 'https://developer.mozilla.org/ru/docs/Web/HTML/Element';
...
for await (let [_key, link] of links){
  ...
  result.set( filename, {
    ...
    lang: 'HTML',
    langIndex: 'html',
    filter: title.toLocaleLowerCase() + ' html',
  })
}
